...
class COO : public SparseMatrix<fp_type>
{
     ...
     public:
        ...
        COO(const size_t nrows, const size_t ncols):SparseMatrix<fp_type>(nrows, ncols){};
      ...
      /*
        ...
        */
        void getCOO(std::vector<fp_type> &vals, std::vector<size_t> &idx_col, std::vector<size_t> &idx_row) const override;
